...
def roll_dice(num_rolls, dice=six_sided):
    ...
    "*** YOUR CODE HERE ***"
    counted,number = 0,0
    # record number of throws for 1

    while num_rolls > 0:
        outcome = dice()
        counted = counted + outcome
...
def free_bacon(score):
    ...
    t = score % 10
    r = (score//10)%10
    free = r*2-t#free stores value for free_bacon
    if free <= 0:
        return 1
    else:
        return free
...
def is_swap(player_score, opponent_score):
    ...
    def swapping(score):
        ...
        t = (score//10) % 10
        return abs(p-t)
    if swapping(player_score)==swapping(opponent_score):
        return True
    else:
        return False
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if player == 0:
            ...
            r = is_swap(score0,score1)
            if r == True:
                p, score0 = score0, score1
                score1 = p
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def make_difference(score0,score1):
        n = previous_score
        p = previous_high
        r = 0
        ...
        if r > p:
            p = r
            print(r, "point(s)! That's the biggest gain yet for Player", who)


        return announce_highest(who,p,n)
...
def bacon_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if n >= margin:# Replace this statement
        return 0
    else:
        return num_rolls
    # END PROBLEM 10
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    n = free_bacon(opponent_score)# Replace this statement
    t = n + score
    if t < opponent_score and is_swap(t,opponent_score):
        return 0

    elif not(is_swap(t,opponent_score)) and n >= margin and t > opponent_score:
        return 0

    elif t < opponent_score and n >= margin:
        return 0
